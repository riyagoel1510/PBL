...
const ReportPage = () => {
  ...
  const [selectedPlatform, setSelectedPlatform] = useState("Select Platform"); // State for selected platform
      ...
      <div className="complaint-details">
        ...
        <form className="complaint-form">
          <div className="form-group">
            <label>Approximate Date and Time of <br /> Incident/Receiving/Viewing of Content:</label>
          ...
          <div className="form-group">
            ...
            <select value={selectedState} onChange={handleStateChange}>
              ...
              {/* Loop through the array of Indian states to generate options */}
          ...
          <div className="form-group">
            ...
            <select>
              ...
              {/* Add options for police stations */}
            </select>
          </div>
          <div className="form-group">
            <label>In Which Platform Did the Incident Occur:</label>
          ...
          <div className="form-group">
            <label>Please Explain the Incident in Detail in Your Own Words:</label>
            <textarea></textarea>
          </div>
